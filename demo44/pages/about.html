																	...
																	<div class="row">
																		...
																		<div class="col-lg-3 mb-6 mb-lg-0">
																			...
																			<div class="mb-6">
																				...
																				<div class="menu-item p-0 m-0">
																					<!--begin:Menu link-->
																					<a href="../../demo44/dist/pages/about.html" class="menu-link active">
								...
								<div id="kt_app_sidebar_menu_wrapper" class="hover-scroll-y px-1 px-lg-5" data-kt-sticky="true" data-kt-sticky-name="app-sidebar-menu-sticky" data-kt-sticky-offset="{default: false, xl: '500px'}" data-kt-sticky-release="#kt_app_stats" data-kt-sticky-width="250px" data-kt-sticky-left="auto" data-kt-sticky-top="100px" data-kt-sticky-animation="false" data-kt-sticky-zindex="95" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header, #kt_app_header" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="20px">
									...
									<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link active" href="../../demo44/dist/pages/about.html">
													<span class="menu-bullet">
														<span class="bullet bullet-dot"></span>
													</span>
													<span class="menu-title">About</span>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">About Us</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
											...
											<div class="card bg-light mb-18">
												...
												<div class="card-body py-15">
													...
													<div class="fs-2 fw-semibold text-muted text-center">
														<a href="../../demo44/dist/account/security.html" class="link-primary fs-4 fw-bold">Marcus Levy</a>
														...
														<div class="card-xl-stretch me-md-6">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="../../demo44/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Jane Miller</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch mx-md-3">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="../../demo44/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Cris Morgan</a>
																	<!--end::Author-->
																	<!--begin::Date-->
													...
													<div class="col-md-4">
														...
														<div class="card-xl-stretch ms-md-6">
															...
															<div class="m-0">
																...
																<div class="fs-6 fw-bold">
																	<!--begin::Author-->
																	<a href="../../demo44/dist/apps/projects/users.html" class="text-gray-700 text-hover-primary">Carles Nilson</a>
																	<!--end::Author-->
																	<!--begin::Date-->
