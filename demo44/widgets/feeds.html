														...
														<div class="tab-pane active w-lg-500px" id="kt_app_header_menu_pages_widgets">
															...
															<div class="row">
																...
																<div class="col-lg-4 mb-6 mb-lg-0">
																	...
																	<div class="menu-item p-0 m-0">
																		<!--begin:Menu link-->
																		<a href="../../demo44/dist/widgets/feeds.html" class="menu-link active">
																			<span class="menu-title">Feeds</span>
																		</a>
																		<!--end:Menu link-->
																	</div>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">Feeds</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body pb-0">
													...
													<div class="mb-5">
														...
														<div class="d-flex align-items-center mb-5">
															<a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
															<i class="ki-outline ki-message-text-2 fs-2"></i>89</a>
															<a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
															<i class="ki-outline ki-heart fs-2"></i>29</a>
														</div>
														<!--end::Toolbar-->
													</div>
													<!--end::Post-->
											...
											<div class="card mb-5 mb-xl-8">
												...
												<div class="card-body pb-0">
													...
													<div class="mb-6">
														...
														<div class="d-flex align-items-center mb-5">
															<a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-success px-4 py-2 me-4">
															<i class="ki-outline ki-message-text-2 fs-2"></i>189</a>
															<a href="#" class="btn btn-sm btn-light btn-color-muted btn-active-light-danger px-4 py-2">
															<i class="ki-outline ki-heart fs-2"></i>229</a>
														</div>
														<!--end::Toolbar-->
													</div>
													<!--end::Bottom-->
