											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="../../demo44/dist/apps/file-manager/folders.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-500 mx-n1">File Manager</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">File Manager - Folders</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
										...
										<div class="card-body pb-0">
											...
											<div class="d-flex overflow-auto h-55px">
												<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-semibold flex-nowrap">
													<!--begin::Nav item-->
													<li class="nav-item">
														<a class="nav-link text-active-primary me-6 active" href="../../demo44/dist/apps/file-manager/folders.html">Files</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item">
														<a class="nav-link text-active-primary me-6" href="../../demo44/dist/apps/file-manager/settings.html">Settings</a>
													</li>
													<!--end::Nav item-->
												</ul>
											</div>
													...
													<tr>
														...
														<td data-order="account">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">account</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
															...
															<div class="d-flex justify-content-end">
																		...
																		<div class="card card-flush">
																			<div class="card-body p-5">
																				...
																				<div class="d-flex flex-column text-start d-none" data-kt-filemanger-table="copy_link_result">
																					...
																					<a href="../../demo44/dist/apps/file-manager/settings/.html" class="ms-2">Change permissions</a></div>
																				</div>
																				<!--end::Link-->
																			</div>
																		</div>
																...
																<div class="ms-2">
																	...
																	<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
																			<a href="../../demo44/dist/apps/file-manager/files.html" class="menu-link px-3">View</a>
																		</div>
																		<!--end::Menu item-->
																		<!--begin::Menu item-->
																		<div class="menu-item px-3">
													...
													<tr>
														...
														<td data-order="apps">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">apps</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="widgets">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">widgets</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="assets">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">assets</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="documentation">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">documentation</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="layouts">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">layouts</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="modals">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">modals</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="authentication">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">authentication</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="dashboards">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">dashboards</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="media">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">media</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="customers">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">customers</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="user-management">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">user-management</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="subscriptions">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">subscriptions</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="forms">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">forms</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="buttons">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">buttons</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="datatables">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">datatables</a>
															</div>
														</td>
														<td>-</td>
														<td>-</td>
													...
													<tr>
														...
														<td data-order="index.html">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">index.html</a>
															</div>
														</td>
														<td>583 KB</td>
													...
													<tr>
														...
														<td data-order="landing.html">
															<div class="d-flex align-items-center">
																...
																<a href="../../demo44/dist/apps/file-manager/files/.html" class="text-gray-800 text-hover-primary">landing.html</a>
															</div>
														</td>
														<td>87 KB</td>
														<td>05 May 2023, 5:20 pm</td>
