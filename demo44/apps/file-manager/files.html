											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="../../demo44/dist/apps/file-manager/files.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Files</span>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">File Manager - Files</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
										...
										<div class="card-header pt-8">
											...
											<div class="card-toolbar">
												...
												<div class="d-flex justify-content-end" data-kt-filemanager-table-toolbar="base">
													...
													<a href="../../demo44/dist/apps/file-manager/folders.html" class="btn btn-icon btn-light-primary me-3">
										...
										<div class="card-body">
											...
											<div class="d-flex flex-stack">
												...
												<div class="badge badge-lg badge-light-primary">
													...
													<a href="../../demo44/dist/apps/file-manager/folders.html">Keenthemes</a>
													<i class="ki-outline ki-right fs-2x text-primary mx-1"></i>
													<a href="../../demo44/dist/apps/file-manager/folders.html">themes</a>
													<i class="ki-outline ki-right fs-2x text-primary mx-1"></i>
													<a href="../../demo44/dist/apps/file-manager/folders.html">html</a>
													<i class="ki-outline ki-right fs-2x text-primary mx-1"></i>
													<a href="../../demo44/dist/apps/file-manager/folders.html">demo1</a>
													<i class="ki-outline ki-right fs-2x text-primary mx-1"></i>account</div>
												</div>
												<!--end::Folder path-->
												<!--begin::Folder Stats-->
