											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="../../demo44/dist/apps/customers/view.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">Customer Details</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">3584-5992</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">6934-4101</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">6467-6310</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">2464-9305</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">8834-9412</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">7801-1095</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9711-7020</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">7040-3117</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">7106-6555</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<td class="text-gray-800">**** 6536</td>
																				</tr>
																				<tr>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 4609</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																	...
																	<div class="d-flex flex-wrap py-5">
																		...
																		<div class="flex-equal me-5">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Number</td>
																					<td class="text-gray-800">**** 9229</td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">Expires</td>
																...
																<table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_customers_logs">
																	<tbody>
																		<tr>
																			...
																			<td>POST /v1/invoices/in_3745_2745/payment</td>
																			<td class="pe-0 text-end min-w-200px">21 Feb 2023, 8:43 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																			</td>
																			<td>POST /v1/customer/c_64b780dcadab7/not_found</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_7070_1494/payment</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_6563_5493/invalid</td>
																			<td class="pe-0 text-end min-w-200px">10 Nov 2023, 5:20 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																		...
																		<tr>
																			...
																			<td>POST /v1/invoices/in_1908_9402/payment</td>
																			<td class="pe-0 text-end min-w-200px">10 Mar 2023, 10:10 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-success">200 OK</div>
																		...
																		<tr>
																			...
																			<td>POST /v1/invoice/in_2225_3004/invalid</td>
																		...
																		<tr>
																			...
																			<td>POST /v1/customer/c_64b780dcadab8/not_found</td>
																			<td class="pe-0 text-end min-w-200px">24 Jun 2023, 10:10 pm</td>
																		</tr>
																		<tr>
																			<td class="min-w-70px">
																				<div class="badge badge-light-warning">404 WRN</div>
																			</td>
																			<td>POST /v1/customer/c_64b780dcadab9/not_found</td>
																			<td class="pe-0 text-end min-w-200px">10 Nov 2023, 9:23 pm</td>
																		</tr>
																	</tbody>
																</table>
															...
															<table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
																<tbody>
																	...
																	<tr>
																		...
																		<span class="badge badge-light-info me-1">In Progress</span>to
																		<span class="badge badge-light-primary">In Transit</span></td>
																		<td class="pe-0 text-gray-600 text-end min-w-200px">15 Apr 2023, 10:10 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2023, 11:30 am</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Brian Cox</a>has made payment to
																	...
																	<tr>
																		...
																		<td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2023, 9:23 pm</td>
																	</tr>
																	<tr>
																		<td class="min-w-400px">
																		<a href="#" class="text-gray-600 text-hover-primary me-1">Brian Cox</a>has made payment to
