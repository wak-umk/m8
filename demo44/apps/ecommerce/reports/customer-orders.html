													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion menu-sub-indention">
															...
															<div class="menu-sub menu-sub-accordion">
																...
																<div class="menu-item">
																	<!--begin:Menu link-->
																	<a class="menu-link active" href="../../demo44/dist/apps/ecommerce/reports/customer-orders.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">Customer Orders Report</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
										...
										<div class="card-body pt-0">
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_report_customer_orders_table">
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Emma Smith</a>
														</td>
														<td>
														...
														<td class="text-end">$3543.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Melody Macy</a>
														</td>
														<td>
														...
														<td class="text-end">$3285.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Max Smith</a>
														</td>
														<td>
														...
														<td class="text-end">$2257.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Sean Bean</a>
														</td>
														<td>
														...
														<td class="text-end">$2204.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Brian Cox</a>
														</td>
														<td>
														...
														<td class="text-end">$826.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Mikaela Collins</a>
														</td>
														<td>
														...
														<td class="text-end">$4872.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Francis Mitcham</a>
														</td>
														<td>
														...
														<td class="text-end">$2920.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Olivia Wild</a>
														</td>
														<td>
														...
														<td class="text-end">$4632.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Neil Owen</a>
														</td>
														<td>
													...
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Dan Wilson</a>
														</td>
														<td>
														...
														<td class="text-end">$4912.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Emma Bold</a>
														</td>
														<td>
													...
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Ana Crown</a>
														</td>
														<td>
														...
														<td class="text-end">$1267.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Robert Doe</a>
														</td>
														<td>
														...
														<td class="text-end">$4986.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">John Miller</a>
														</td>
														<td>
														...
														<td class="text-end">$3458.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Lucy Kunic</a>
														</td>
														<td>
														...
														<td class="text-end">$3887.00</td>
													</tr>
													<tr>
														<td>
															<a href="../../demo44/dist/apps/ecommerce/customers/details.html" class="text-dark text-hover-primary">Ethan Wilder</a>
														</td>
														<td>
