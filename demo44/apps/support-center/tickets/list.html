													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
															...
															<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																...
																<div class="menu-item">
																	<!--begin:Menu link-->
																	<a class="menu-link active" href="../../demo44/dist/apps/support-center/tickets/list.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7">
												...
												<!--end::Item-->
												<!--begin::Item-->
												<li class="breadcrumb-item text-gray-500 mx-n1">Tickets</li>
												<!--end::Item-->
											</ul>
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">Tickets List</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
										...
										<div class="card-body flex-column p-5">
											...
											<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
												...
												<ul class="nav flex-wrap border-transparent fw-bold">
													...
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="../../demo44/dist/apps/support-center/tickets/list.html">tickets</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
														...
														<div class="mb-10">
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">How to use Netronic with Django Framework?</a>
																		<!--end::Title-->
																		<!--begin::Label-->
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme npm issue</a>
																		<!--end::Title-->
																		<!--begin::Label-->
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme authentication to node.js / strapi backend</a>
																		<!--end::Title-->
																		<!--begin::Label-->
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">How to use Admin theme with Django Framework?</a>
																		<!--end::Title-->
																		<!--begin::Label-->
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Reducing footprint of Start theme</a>
																		<!--end::Title-->
																		<!--begin::Label-->
																		<span class="badge badge-light my-1">Angular</span>
																		<!--end::Label-->
															...
															<div class="d-flex mb-10">
																...
																<div class="d-flex flex-column">
																	...
																	<div class="d-flex align-items-center mb-2">
																		<!--begin::Title-->
																		<a href="../../demo44/dist/apps/support-center/tickets/view.html" class="text-dark text-hover-primary fs-4 me-3 fw-semibold">Admin theme node.js / strapi backend</a>
																		<!--end::Title-->
																		<!--begin::Label-->
																		<span class="badge badge-light my-1">React</span>
																		<!--end::Label-->
