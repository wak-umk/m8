													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
															...
															<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
																...
																<div class="menu-item">
																	<!--begin:Menu link-->
																	<a class="menu-link active" href="../../demo44/dist/apps/support-center/tickets/view.html">
																		<span class="menu-bullet">
																			<span class="bullet bullet-dot"></span>
																		</span>
								...
								<div id="kt_app_toolbar" class="app-toolbar pt-7 pt-lg-10">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
											...
											<!--end::Breadcrumb-->
											<!--begin::Title-->
											<h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-3 m-0">View Tickets</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->
																...
																<div class="mb-10">
																	...
																	<div class="highlight">
																		...
																		<ul class="nav nav-pills" role="tablist">
																			<li class="nav-item">
																				<a class="nav-link active" data-bs-toggle="tab" href="#kt_highlight_64b780d93cb4d" role="tab">JAVASCRIPT</a>
																			</li>
																			<li class="nav-item">
																				<a class="nav-link" data-bs-toggle="tab" href="#kt_highlight_64b780d93cb50" role="tab">HTML</a>
																			</li>
																		</ul>
																		<div class="tab-content">
																			<div class="tab-pane fade show active" id="kt_highlight_64b780d93cb4d" role="tabpanel">
...
setTimeout(function() {
    button.removeAttribute(&quot;data-kt-indicator&quot;);
																			...
																			<div class="tab-pane fade" id="kt_highlight_64b780d93cb50" role="tabpanel">
																				<div class="highlight-code">
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo44/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Sandra Piquet</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo44/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Bob Clarcson</a>
																						<!--end::Username-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo44/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Matthew</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
																		...
																		<div class="w-100 d-flex flex-stack mb-8">
																			...
																			<div class="d-flex align-items-center f">
																				...
																				<div class="d-flex flex-column fw-semibold fs-5 text-gray-600 text-dark">
																					...
																					<div class="d-flex align-items-center">
																						<!--begin::Username-->
																						<a href="../../demo44/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary fs-5 me-3">Boris</a>
																						<!--end::Username-->
																						<span class="m-0"></span>
																					</div>
																					<!--end::Text-->
