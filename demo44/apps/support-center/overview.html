											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-250px">
												...
												<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item here show menu-lg-down-accordion">
													...
													<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
														...
														<div class="menu-item">
															<!--begin:Menu link-->
															<a class="menu-link active" href="../../demo44/dist/apps/support-center/overview.html">
																<span class="menu-bullet">
																	<span class="bullet bullet-dot"></span>
																</span>
																<span class="menu-title">Overview</span>
											...
											<div class="card-rounded bg-light d-flex flex-stack flex-wrap p-5">
												...
												<ul class="nav flex-wrap border-transparent fw-bold">
													...
													<li class="nav-item my-1">
														<a class="btn btn-color-gray-600 btn-active-secondary btn-active-color-primary fw-bolder fs-8 fs-lg-base nav-link px-3 px-lg-8 mx-1 text-uppercase active" href="../../demo44/dist/apps/support-center/overview.html">Overview</a>
													</li>
													<!--end::Nav item-->
													<!--begin::Nav item-->
													<li class="nav-item my-1">
											...
											<div class="card card-md-stretch me-xl-3 mb-md-0 mb-6">
												...
												<div class="card-body p-10 p-lg-15">
													...
													<div class="d-flex flex-stack mb-7">
														...
														<div class="d-flex align-items-center">
															<!--begin::Link-->
															<a href="../../demo44/dist/apps/support-center/tutorials/list.html" class="text-primary fw-bold me-1">All Tutorials</a>
															<!--begin::Link-->
															<!--begin::Arrow-->
															<i class="ki-outline ki-arrow-right fs-2 text-primary"></i>
															<!--end::Arrow-->
											...
											<div class="row">
												...
												<div class="col-sm-4">
													...
													<div class="d-flex align-items-center mb-6">
														<!--begin::Icon-->
														<i class="ki-outline ki-right fs-2 ms-n1 me-4"></i>
														<!--end::Icon-->
														<!--begin::Subtitle-->
